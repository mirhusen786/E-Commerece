...
class FrontController extends Controller
{
    ...
    // for multiple image display for a single product
...
// to display a related product 

    $result['related_product']=
    DB::table('products')
    ->where(['status'=>1])
    ->where('slug','!=',$slug)
    ->where(['category_id'=>$result['product'][0]
    ->category_id])
    ->get();
    ...
    foreach($result['related_product'] as $list1){
        $result['related_product_attr'][$list1->id]=
         ...
         return view('Frontend.Product.product',$result);
    }
    ...
    public function add_to_cart(Request $request)
    {
        ...
        // {
        //      return response()->json(['msg'=>"not avaliable",'data'=>"Only $finalAvaliable Left"]);
        // }
    ...
    public function cart(Request $request)
    {
        ...
        $result['list']=DB::table('cart')
            ...
            // prx($result);
        return view('Frontend.Product.cart',$result);
    }
...
{   
    $result['product']=
            ...
            foreach($result['product'] as $list1){
              ...
              return view('Frontend.Product.search',$result);
}
...
// Registration Controller
            ...
            public function registration(Request $request)
            {
                ...
                return view('Frontend.Product.registration');
            }
            ...
            public function registration_process(Request $request)
            {
               ...
               if(!$valid->passes()){
                    ...
                    if($query){
                        ...
                        Mail::send('Frontend/Product/email_verification',$data,function($messages) use ($user){
                            $messages->to($user['to']);
    ...
    else
    {
        ...
        public function forgot_password_change(Request $request,$id)
        {
            ...
            if(isset($result[0])){
                ...
                return view('Frontend.Product.forgot_password_change');
            }else{
                return redirect('/');
            }
        }
