...
class ProductController extends Controller
{
        ...
        {
            $cat['data']=Product::all();
           return view('Admin/Product/Product',$cat);
        }
        ...
        public function manage_product_process(Request $request)
        {
            ...
            if($request->post('id')>0){
                ...
                $model=new Product();
                $msg="Product is successfully  inserted";
            }
            ...
            foreach($skuArr as $key=>$val){
                ...
                $productAttrArr['sku']=(int)$skuArr[$key];
                ...
                if($request->hasFile("attr_image.$key")){
                    ...
                    if($paidArr[$key]!='')
                {
                $arrImage=DB::table('products_attr')->where(['id'=>$paidArr])->get();
            ...
            foreach($piidArr as $key=>$val){
                ...
                if($request->hasFile("images.$key")){
                    ...
                    if($piidArr[$key]!='')
                    {
                    $arrImage=DB::table('product_images')->where(['id'=>$piidArr])->get();
