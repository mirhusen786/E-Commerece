                  ...
                  <div class="row">
                     <div class="col-6">
                        <div class="form-group has-success">
                           ...
                           <input  name="tax_desc" type="text" value="{{$tax_desc}}" class="form-control cc-name valid" required>
                        </div>
                     </div>
                     <div class="col-6">
                        <div class="form-group has-success">
                           <label for="cc-name" class="control-label lg-12">Tax Value</label>
                           <input  name="tax_value" type="text" value="{{$tax_value}}" class="form-control cc-name valid" required>
                           @error('tax_value')       
