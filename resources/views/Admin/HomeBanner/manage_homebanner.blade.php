                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="image" value="{{$image}}" class="form-control cc-exp" />
                                        @error('image')
                                        <div class="alert alert-danger" role="alert">
                                            {{$message}}
                                        </div>
                                        @enderror @if($image!='')
                                        <img width="80px" height="80px" src="{{asset('storage/media/Home_Banner/'.$image)}}" />
                                        @endif
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="btn_txt" value="{{$btn_txt}}" class="form-control cc-exp" />
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="btn_link" value="{{$btn_link}}" class="form-control cc-exp" />
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="slug" value="{{$slug}}" class="form-control cc-exp">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="msg" value="{{$msg}}" class="form-control cc-exp" required>
