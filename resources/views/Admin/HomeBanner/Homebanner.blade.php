@extends('Admin.layout') @section('page_title','Home Banner') @section('homebanner_select','active') @section('container')
            ...
            <table class="table table-borderless table-data3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{url('admin/homebanner/manage_homebanner/')}}/{{$data->id}}"> <i class="fas fa-edit"></i> </a>

                            &nbsp; &nbsp;
                            <a href="{{url('admin/homebanner/delete')}}/{{$data->id}}"> <i class="fas fa-trash"></i> </a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
