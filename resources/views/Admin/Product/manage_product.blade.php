               ...
               <div class="card">
                  <div class="card-body">
                     ...
                     <div class="form-group">
                        <div class="row">
                           <div class="col-md-4">
                              <label for="category_id" class="control-label mb-1">Name</label>
                           ...
                           <div class="col-md-4">
                              ...
                              @if($image!='')
                              <a href="{{asset('storage/media/'.$image)}}" target="_blank"><img width="60px" src="{{asset('storage/media/'.$image)}}"/></a>
                              @endif
                              @error('image')
                              <div class="alert alert-danger" role="alert">
                                 {{$message}}		
                     ...
                     <div class="form-group">
                        <div class="row">
                           <div class="col-md-6">
                              <label for="category_id" class="control-label mb-1"><b>Short Description</b></label>
                           ...
                           <div class="col-md-6">
                              <label for="category_id" class="control-label mb-1"><b>Technical Specification</b></label>
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              ...
                              <textarea id="lead_time" name="lead_time" type="text" class="form-control" aria-required="true" aria-invalid="false" required>{{$lead_time}}</textarea>
                           </div>
                        </div>
                     </div>
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              ...
                              <input id="taxt_type" name="tax_type" value="{{$tax_type}}" type="text" class="form-control" aria-required="true" aria-invalid="false" required>
                           </div>
                           <div class="col-md-4">
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              ...
                              <input id="attr_image" name="attr_image[]" type="file" class="form-control" value="{{$pAArr['attr_image']}}" aria-required="true" aria-invalid="false">
                              @if($pAArr['attr_image']!='')
                              <img width="50px" src="{{asset('storage/media/'.$pAArr['attr_image'])}}"  />
                              @endif
                           </div>
                           <div class="col-md-2">
...
<script>
   ...
   function add_more(){
       loop_count++;
       var html='<input type="hidden" id="paid" type="text" name="paid[]"><div class="card" id="product_attr_'+loop_count+'"><div class="card-body"><div class="form-group"><div class="row">';
       ...
       html+='<div class="col-md-2"><label for="attr_image" class="control-label mb-1"> &nbsp;&nbsp;&nbsp;</label><br><button type="button" class="btn btn-danger btn-lg" onclick=remove_more("'+loop_count+'")><i class="fa fa-minus"></i>&nbsp; Remove</button></div>'; 
   ...
   function add_image_more(){
      loop_image_count++;
    var html=' <input id="piid" type="hidden" name="piid[]" value="{{$pIArr['id']}}"><div class="col-md-4 product_images_'+loop_image_count+'"><label for="images" class="control-label mb-1"> Image</label><input id="images" name="images[]" type="file" class="form-control" aria-required="true" aria-invalid="false" required></div>';
   
       html+='<div class="col-md-2 product_images_'+loop_image_count+'"><label for="attr_image" class="control-label mb-1"> &nbsp;&nbsp;&nbsp;</label><br><button type="button" class="btn btn-danger btn-lg" onclick=remove_image_more("'+loop_image_count+'")><i class="fa fa-minus"></i>&nbsp; Remove</button></div>'; 
