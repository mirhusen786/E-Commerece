                  ...
                  <div class="row">
                     <div class="col-6">
                        <div class="form-group">
                           ...
                           <input  name="category_name" value="{{$category_name}}" class="form-control cc-exp" required>
                           @error('category_name')       
                        ...
                        <div class="col-6">
                           <div class="form-group">
                              ...
                              <input  name="category_slug"  value="{{$category_slug}}" class="form-control cc-exp" required>
                              @error('category_slug')       
                              <div class="alert alert-danger">
                                 {{$message}}
                              </div>
                        ...
                        <div class="col-6">
                           <div class="form-group">
                              ...
                              @if($category_image!='')
                              <a href="{{asset('storage/media/category/category'.$category_image)}}" target="_blank"><img width="60px" src="{{asset('storage/media/category/'.$category_image)}}"/></a>
                              @endif
                           </div>
                        </div>
                        <div class="col-6">
